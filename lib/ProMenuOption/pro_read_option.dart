...
import 'package:jiwdopani/proPrecious/PreciousMain.dart' hide MyApp;
import 'package:jiwdopani/Promoters/ProMenu.dart';
import 'package:jiwdopani/UserLogIn/MenuUse.dart';
import 'package:jiwdopani/ProMenuOption/JpSelect.dart';

class ProReadOption extends StatefulWidget {
  @override
  _ProReadOptionState createState() => _ProReadOptionState();
}

class _ProReadOptionState extends State<ProReadOption> {
  @override
          ...
          appBar: AppBar(
              ...
              leading: IconButton(
                  ...
                  onPressed: () => Navigator.of(context).pop())),
                     ...
                     // MaterialPageRoute(builder: (_) => promotersDash())))),
          body: SafeArea(
