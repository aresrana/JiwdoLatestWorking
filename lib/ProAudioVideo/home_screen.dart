...
import 'package:jiwdopani/ProAudioVideo/video_screen.dart';
...
class _VideoHomeScreenState extends State<VideoHomeScreen> {
  ...
  _initChannel() async {
    Channels channel = await ProAPIService.instance
  ...
  _loadMoreVideos() async {
    _isLoading = true;
    List<Video> moreVideos = await ProAPIService.instance
