...
class FabCircularMenu extends StatefulWidget {
  ...
  FabCircularMenu({
    ...
    this.animationDuration = const Duration(milliseconds: 800), Alignment alignment, List<Container> children
  });
  @override
...
class _FabCircularMenuState extends State<FabCircularMenu>
  ...
  void didChangeDependencies() {
    ...
    scaleCurve = CurvedAnimation(
        parent: controller, curve: Interval(0.0, 0.4, curve: Curves.easeInToLinear)
    );
    ...
    rotateCurve = CurvedAnimation(
        parent: controller, curve: Interval(0.4, 1.0, curve: Curves.elasticIn) // easeInOutCirc)
    );
